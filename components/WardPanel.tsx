  ...
  return (
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="flex-none px-5 pt-4 pb-3 border-b border-border-subtle">
        <button
          onClick={onBack}
          className="flex items-center gap-1.5 text-text-muted hover:text-text-primary text-sm mb-3 transition-colors cursor-pointer"
        >
      ...
      {/* AI Brief — above gap list for quick access */}
        ...
        {brief ? (
          <div>
            ...
            <button
              ...
              className="mt-3 flex items-center gap-1.5 text-xs text-text-muted hover:text-text-primary border border-border-subtle hover:border-coral rounded-md px-3 py-1.5 transition-colors disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
            >
              {briefLoading ? (
          ...
          <button
            ...
            className="flex items-center gap-2 bg-coral hover:bg-coral/90 disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer text-white font-semibold text-sm px-4 py-2 rounded-lg transition-colors"
          >
      ...
      {/* Gap locations */}
      <div className="flex-1 px-5 pb-4 border-t border-border-subtle pt-4">
        <div className="flex items-center gap-2 mb-3">
